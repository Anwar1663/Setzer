...
class KeyboardShortcutsDialog(object):
    ...
    def __init__(self, main_window):
        ...
        #section = {'title': _('Custom Shortcuts'), 'items': list()}
        #section['items'].append({'title': _('Unlabeled Centered Math Section'), 'shortcut': '&lt;ctrl&gt;M'})
        #section['items'].append({'title': _('Start Matrix Environment'), 'shortcut': '&lt;ctrl&gt;&lt;shift&gt;M'})
        #section['items'].append({'title': _('Equation'), 'shortcut': '&lt;ctrl&gt;&lt;shift&gt;N'})
        #section['items'].append({'title': _('Begin Circuit Diagram'), 'shortcut': '&lt;ctrl&gt;&lt;shift&gt;C'})
        #section['items'].append({'title': _('Add Node Type Component'), 'shortcut': '&lt;ctrl&gt;&lt;shift&gt;X'})
        #section['items'].append({'title': _('Add Bipole Type Component'), 'shortcut': '&lt;ctrl&gt;&lt;shift&gt;B'})
        #section['items'].append({'title': _('Start PGFPlots'), 'shortcut': '&lt;ctrl&gt;P'})
        #section['items'].append({'title': _('Configure PGFPlots'), 'shortcut': '&lt;ctrl&gt;&lt;shift&gt;P'})
        ...
        section = {'title': _('My Shortcuts'), 'items': list()}
        section['items'].append({'title': _('Unlabeled Centered Math Section'), 'shortcut': '&lt;ctrl&gt;M'})
        section['items'].append({'title': _('Start Matrix Environment'), 'shortcut': '&lt;ctrl&gt;&lt;shift&gt;M'})
        section['items'].append({'title': _('Equation'), 'shortcut': '&lt;ctrl&gt;&lt;shift&gt;N'})
        section['items'].append({'title': _('Begin Circuit Diagram'), 'shortcut': '&lt;ctrl&gt;&lt;shift&gt;C'})
